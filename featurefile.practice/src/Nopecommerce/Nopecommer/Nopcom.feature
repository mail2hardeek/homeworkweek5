Feature: NopCommerce Registration
  ...
  As a User I want to check the register functionality of Nop
  ...
  Scenario Outline: I should not be able to register with invalid data on manatory field (*) of registration page
    ...
    Examples:
      ...
      |Rohan     |bakshi   |bakshi@gmail.co |""      |456897           |password is required                      |
      |Rohan     |bakshi   |bakshi@gmail.co |456897  |""               |confirm password is required              |
      |Rohan     |bakshi   |bakshi@gmail.co |456897  |45689            |password and confirm password do not match|
      |Rohan     |bakshi   |bakshi@gmail.co |45689   |""               |minimum 6 character password is required  |
